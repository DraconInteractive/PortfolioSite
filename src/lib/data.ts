...
export const projects: Project[] = [
  ...
  },
  {
    ...
    type: "personal",
    description:
      "A local command-and-control network for ESP32 devices. Voice commands stream from a handheld controller to a Python server, which transcribes, interprets, and dispatches events to a mesh of displays, cameras, and button nodes. A relay server provides authenticated external access to the dashboard from outside the local network.",
    overview: [
    ...
    media: [
      {
        ...
        type: "image",
        caption: "Browser dashboard — device state, recent commands, diagnostics, and action controls",
        cols: 12,
      },
      {
        src: "/assets/esp home/sc_dashboard_devices.png",
        type: "image",
        caption: "Dashboard devices tab — registered devices with online/offline state",
        cols: 6,
      },
      {
        src: "/assets/esp home/sc_dashboard_deviceDetails.png",
        type: "image",
        caption: "Device details — firmware version, capabilities, and event queue",
        cols: 6,
      },
      {
        src: "/assets/esp home/sc_relay_devices.png",
        type: "image",
        caption: "Relay server — connected devices registered for external access",
        cols: 6,
      },
      {
        src: "/assets/esp home/sc_relay_events.png",
        type: "image",
        caption: "Relay server — event log for proxied external requests",
        cols: 6,
      },
    ],
  },
